...
$Computer = $_REQUEST['Computer'];
    ...
    $sql="INSERT INTO admission(Student_Id, StudentName,EmailId,Mobile_no, Branch, Course,Year,Gender, Blood, Parent, ParentName, ParentContact, Address,KVBAcc,Computer,Ironbox,Phy,Profile) VALUES ('$Student_Id','$StudentName','$EmailId','$Mobile_no','$Branch','$Course','$Year','$Gender','$Blood','$Parent','$ParentName','$ParentContact','$Address','$KVBAcc','$Computer','$Ironbox','$Phy','$Profile')";
...
echo '<script> alert("Request Hostel admission done successfully"); window.location.href = "";</script>';
  ...
  <?php include 'header.php'; ?>
        ...
        <form action="" method="post" enctype="multipart/form-data" class="box" oninput='Cpassword.setCustomValidity(Cpassword.value != password.value ? "Passwords do not match." : "")'>
          ...
          <div class="formcss">
            ...
            <div class="input-group input-group mb-3">
            <div class="tex">
            <span class="input-group-text" id="inputGroup-sizing-sm"><i class="fa fa-wheelchair" aria-hidden="true"></i>Physically Challenged
                </span> 
