...
$Complaint_Description = $_POST['Complaint_Description'];
    ...
    // <div class=""></div>
    $sql="INSERT INTO complaints(Student_Id, StudentName, EmailId, Contact, Hostel, location, Category, Complaint_Type, Complaint_Description) VALUES ('$Student_Id', '$StudentName', '$EmailId', '$Contact', '$Hostel', '$location', '$Category','$Complaint_Type','$Complaint_Description')";
    mysqli_query($conn,$sql);
    $sql="SELECT * from complaints where Student_Id='$Student_Id'";
    $result=mysqli_query($conn,$sql);
    $row=mysqli_fetch_array($result);
    
$url = 'http://myclientsinfo.com/arun/mail.php';
$ch = curl_init($url);
$data = array(  'to' => $EmailId,'subject'=>'Complaint Registration' ,   'message' => ' <p>Your Complaint Has been Registered Successfully.<br> Your Complaint id is: <p>'.$row['id'] );
...
<body>
  <?php include'header.php';?>
        ...
        <form  method="post" class="box" oninput='Cpassword.setCustomValidity(Cpassword.value != password.value ? "Passwords do not match." : "")'>
