...
//         $('#Vacate').datepicker('option', 'minDate', new Date(dateText));
//     },
// });

// $('#Vacate').datepicker({
//     onSelect: function(dateText, inst){
//         $('#BookingFrom').datepicker('option', 'maxDate', new Date(dateText));
//     }
// });
...
//           $("#Vacate").datepicker("option","minDate", selected)
//         }
//     });
//     $("#Vacate").datepicker({ 
//         minDate: 0,
...
//         numberOfMonths: 2,
//         onSelect: function(selected) {
//            $("#BookingFrom").datepicker("option","maxDate", selected)
//         }
//     });  
// });
