...
<body>
 ...
 <?php include 'adminheader.php'; ?>
    ...
    <div class="wrapper">
        ...
        <form action="updaterooms.php" class="" method="post"  oninput='Cpassword.setCustomValidity(Cpassword.value != password.value ? "Passwords do not match." : "")'>
            ...
            <div class="input-group input-group mb-3">
                ...
                <input type="number" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="Floor" name="Floor" placeholder="Enter the Floors number" min="0" max="5" required>
            </div>

                <div class="input-group input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm"><i class="far fa-building"></i></i>
                </span>
                <input type="number" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" id="Room" name="Room" placeholder="Enter the Room number" min="1" max="60" required>
            </div>
            ...
            <div class="input-group input-group mb-3">
              ...
              <select class="form-control" aria-label="Default select example" name="Room_type" required>
                  <option value="" disabled selected hidden>Room Type</option>
                  <option value="Attached">Attached Restroom</option>
                  <option value="NOT_Attached">Not Attached Restroom</option>
                </select><br>
              </div>
           ...
           <div class="field">
                <input class="button" type="submit" name="submit"  value="update Rooms"> </div> 
        </form>
    </div> 
    </div>
</body>
