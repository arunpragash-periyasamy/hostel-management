...
// var courses={
//     BE:['AI','Automobile','Civil','Chemical','CSE','E&I','ECE','Mechanical','Mechatronics'],
//     BTech:['FT','IT'],
//     MSC:['SS','IS']
// }

// var main=document.getElementById('Branch');
// var sub=document.getElementById('Course');

// main.addEventListener('change',function(){


//     var selected_option=courses[this.value];
