...
<body>
  <?php include 'adminheader.php'; ?>
        ...
        <form action="hosteladmission.php" method="post" enctype="multipart/form-data" class="box" oninput='Cpassword.setCustomValidity(Cpassword.value != password.value ? "Passwords do not match." : "")'>
          ...
          <div class="formcss">
              ...
              <!------Course------>
                <div class="input-group input-group mb-3">
                    ...
                    <select class="form-control" aria-label="Default select example" name="Course" required>
                        ...
                        <option value="CT-UG">CSE</option>
                        <option value="CT-PG">Software Systems</option>
            ...
            <div class="input-group input-group mb-3">
              ...
              <div class="tex">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="Computer" name="Computer" id="Computer">
                  <label class="form-check-label" for="Computer">
                    Computer
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="Ironbox" name="Ironbox" id="Ironbox" >
