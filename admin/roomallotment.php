...
$roomallot="SELECT * FROM allotrooms WHERE Gender='$Gender' Branch='$Branch' and Course='$Course' and Year='$Year'";
...
echo '<script> alert("Room alloted Successfully!"); window.location.href = "adminDashboard.php";</script>';
}
}
else{
